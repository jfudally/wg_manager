...
| Zero-touch enrollment from userdata (single-use tokens, separate cert-optional listener) | `POST /v1/enrollment-tokens` (mint), `GET` (list), `POST …/{id}/revoke` + `scripts/enroll_node.sh` |
